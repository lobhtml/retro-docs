...
3.	I do not cover prototypes of licensed games to bypass Rule 1 unless there are significant deviations from the final release that are worth talking about ([Resident Evil 2 protoype](www.youtube.com/watch?v=4-BHWq4iJH4), for example).
4.	There are edge cases where games are available but at an increasingly high cost ([Pokemon DS games](https://lobhtml.github.io/retro-docs/posts/pokemon-ds-cart) or Silent Hill on PS1, for example). As a workaround, I may consider purchasing a variant that is more affordable (a non-English language release, for example) to meet the requirement of “legitimate access”.

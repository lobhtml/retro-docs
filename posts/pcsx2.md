...
The advantage of using PCSX2 is that you can use a PS5 controller via USB. Crucially, you can monitor OBS as you play without needing to switch to another HDMI input. There is also the option of upscaling the game to FHD or even 4K in 16:9 widescreen. You also don’t need to worry about cable management.
